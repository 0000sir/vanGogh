...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post styles_url, params: { style: { author: @style.author, image: @style.image, image_fingerprint: @style.image_fingerprint, title: @style.title } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { author: @style.author, image: @style.image, image_fingerprint: @style.image_fingerprint, title: @style.title } }
